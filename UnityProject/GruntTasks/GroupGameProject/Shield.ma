...
//Name: Shield.ma
//Last modified: Thu, Nov 20, 2025 09:29:55 AM
//Codeset: 1252
...
fileInfo "UUID" "086AEAFA-4E5A-77A4-3247-F384205EA6B0";
createNode transform -s -n "persp";
	rename -uid "4CB0B0F5-44E1-DAE9-29C9-2C85D1485BD4";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 79.714184771585309 -70.524981252604135 235.79553786631411 ;
	setAttr ".r" -type "double3" 20.661647278678515 730.59999999995637 4.0447150011123739e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E8F86031-494C-CB97-11C0-86B9B9D3A7D2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 259.1780123947093;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "32330F2B-4CA3-2DB6-BB65-70B81DF89083";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "75F4DA4B-4D97-1664-1267-5FA63500A224";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "45023986-43EE-CB6B-D3F5-6086D373690A";
createNode displayLayerManager -n "layerManager";
	rename -uid "97C50563-44BE-7BE2-4034-07AA9E5C23A1";
createNode displayLayer -n "defaultLayer";
	rename -uid "563CBA27-4551-5273-D6E0-648D896F5F99";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "58B63ED2-4824-18E4-6DF1-3FABC954E0C7";
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 13 ".tk";
	setAttr ".tk[122]" -type "float3" 0.059381101 0 0 ;
	setAttr ".tk[123]" -type "float3" -2.2680593e-08 0 0 ;
	setAttr ".tk[124]" -type "float3" 1.1030386e-08 0 0 ;
	setAttr ".tk[125]" -type "float3" 0.061640803 0 0 ;
	setAttr ".tk[126]" -type "float3" -0.059381112 0 0 ;
	setAttr ".tk[127]" -type "float3" -0.061640803 0 0 ;
	setAttr ".tk[128]" -type "float3" 0.0616409 0 0 ;
	setAttr ".tk[129]" -type "float3" -2.0078128e-09 0 0 ;
	setAttr ".tk[130]" -type "float3" -4.0156256e-09 0 0 ;
	setAttr ".tk[131]" -type "float3" 0.059381228 0 0 ;
	setAttr ".tk[132]" -type "float3" -0.0616409 0 0 ;
	setAttr ".tk[133]" -type "float3" -0.059381235 0 0 ;
...
createNode polyTweak -n "polyTweak5";
	...
	setAttr ".uopa" yes;
	setAttr -s 13 ".tk";
	setAttr ".tk[146]" -type "float3" 0 0.060358331 -0.058452044 ;
	setAttr ".tk[147]" -type "float3" 0 0.060358331 -0.060385115 ;
	setAttr ".tk[148]" -type "float3" 0 0.060358331 -0.040129419 ;
	setAttr ".tk[149]" -type "float3" 0 0.060358331 -0.039425846 ;
	setAttr ".tk[150]" -type "float3" 0 0.060358331 -0.058452077 ;
	setAttr ".tk[151]" -type "float3" 0 0.060358331 -0.039425857 ;
	setAttr ".tk[152]" -type "float3" 0 0.060358331 0.039425768 ;
	setAttr ".tk[153]" -type "float3" 0 0.060358331 0.040129308 ;
	setAttr ".tk[154]" -type "float3" 0 0.060358331 0.060385115 ;
	setAttr ".tk[155]" -type "float3" 0 0.060358331 0.058452059 ;
	setAttr ".tk[156]" -type "float3" 0 0.060358331 0.039425768 ;
	setAttr ".tk[157]" -type "float3" 0 0.060358331 0.058452059 ;
createNode polyTweak -n "polyTweak6";
	rename -uid "5F6E69A5-4E85-AFA1-D20F-7D8E0626318E";
	setAttr ".uopa" yes;
	setAttr -s 13 ".tk";
	setAttr ".tk[158]" -type "float3" 0 0.074133843 -0.10177774 ;
	setAttr ".tk[159]" -type "float3" 0 0.078129642 -0.1065568 ;
	setAttr ".tk[160]" -type "float3" 0 0.036260322 -0.05648011 ;
	setAttr ".tk[161]" -type "float3" 0 0.034806009 -0.054740705 ;
	setAttr ".tk[162]" -type "float3" 0 0.074134007 -0.10177784 ;
	setAttr ".tk[163]" -type "float3" 0 0.034806058 -0.054740749 ;
	setAttr ".tk[164]" -type "float3" 0 0.03480592 0.054740548 ;
	setAttr ".tk[165]" -type "float3" 0 0.036260191 0.056479841 ;
	setAttr ".tk[166]" -type "float3" 0 0.078129731 0.10655684 ;
	setAttr ".tk[167]" -type "float3" 0 0.074134007 0.10177781 ;
	setAttr ".tk[168]" -type "float3" 0 0.03480592 0.054740548 ;
	setAttr ".tk[169]" -type "float3" 0 0.074134007 0.10177781 ;
...
createNode polyTweak -n "polyTweak8";
	...
	setAttr ".uopa" yes;
	setAttr -s 17 ".tk";
	setAttr ".tk[0]" -type "float3" 0 0.01866387 0 ;
	setAttr ".tk[1]" -type "float3" 0 0.018663229 0 ;
	setAttr ".tk[2]" -type "float3" 0 0.018662946 0 ;
	setAttr ".tk[3]" -type "float3" 0 0.018663229 0 ;
	setAttr ".tk[4]" -type "float3" 0 0.01866387 0 ;
	setAttr ".tk[5]" -type "float3" 0 0.018664088 0 ;
	setAttr ".tk[6]" -type "float3" 0 0.018664088 0 ;
	setAttr ".tk[7]" -type "float3" 0 0.018664118 0 ;
	setAttr ".tk[8]" -type "float3" 0 0.018664118 0 ;
	setAttr ".tk[9]" -type "float3" 0 0.018663922 0 ;
	setAttr ".tk[10]" -type "float3" 0 0.018663257 0 ;
	setAttr ".tk[11]" -type "float3" 0 0.018662946 0 ;
	setAttr ".tk[12]" -type "float3" 0 0.018663257 0 ;
	setAttr ".tk[13]" -type "float3" 0 0.018663922 0 ;
...
createNode polyTweak -n "polyTweak11";
	...
	setAttr ".uopa" yes;
	setAttr -s 7 ".tk";
	setAttr ".tk[39]" -type "float3" 0 2.2551405e-16 0.12216819 ;
	setAttr ".tk[40]" -type "float3" 0 0 0.17068668 ;
	setAttr ".tk[41]" -type "float3" 0 0 0.032240883 ;
	setAttr ".tk[42]" -type "float3" 0 0 0.17068668 ;
	setAttr ".tk[43]" -type "float3" 0 0 0.032240883 ;
	setAttr ".tk[44]" -type "float3" 0 2.2551405e-16 0.12216819 ;
