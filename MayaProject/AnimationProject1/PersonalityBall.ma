...
//Last modified: Tue, Jan 20, 2026 09:44:28 PM
//Codeset: 1252
...
fileInfo "UUID" "C2930B68-45AA-466C-BFCB-059EF79BFF44";
createNode transform -s -n "persp";
	rename -uid "902234CC-4D5B-F376-C44D-AAACF54D340A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.7977875105709806 3.0259597774990574 -6.3162948448106704 ;
	setAttr ".r" -type "double3" -15.338352729598949 146.59999999999371 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "16CD7DC1-4CA0-143F-BD8C-6E85858CE8D4";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.8122819616830839;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "37FBE4F0-4064-8F45-48A5-D8A74994CDFC";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "40D65705-4843-3FD7-C779-6C821466AE2C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3F17C130-4146-CA5A-3072-A3BADCA9DCF1";
createNode displayLayerManager -n "layerManager";
	rename -uid "634076FC-4740-8DFB-8246-92A82D65C8EB";
createNode displayLayer -n "defaultLayer";
	rename -uid "6A83EE1B-489C-9DDC-7B68-00BA8A0671C1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "75F6660A-4113-C697-43E6-8CAC9E431BE4";
