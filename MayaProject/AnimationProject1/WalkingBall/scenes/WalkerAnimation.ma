...
//Last modified: Sun, Oct 12, 2025 04:36:41 PM
//Codeset: 1252
...
fileInfo "UUID" "B69D607E-4526-AC6F-6287-D8A4BC411201";
createNode transform -s -n "persp";
	rename -uid "49F2E69B-43CF-A392-60A6-43AD7E933C44";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.6060712263761969 0.87076140451322592 -3.2835546240512588 ;
	setAttr ".r" -type "double3" -3.9383527296363496 -124.19999999996719 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6E115446-4B90-39DB-BE81-D7B1CEB7BFB1";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5.2224917404196241;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "170F1074-448B-520B-FF0B-7FBBF4225412";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "FEE4A968-4C1E-E311-8441-EA900829D02B";
createNode displayLayer -n "defaultLayer";
	rename -uid "B62D6157-4C7D-E6BF-C836-43AC36397DBB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DD4F955F-421E-B2C6-93D5-9A8A858824DE";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "04B18ADB-4751-B8ED-AFDA-A192C7BE7C4F";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "67F63DEE-4FAD-3D8F-EFCE-A899BE5FEEF4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "ED313A66-46C5-DFA8-7CA2-2399D0B35CFC";
createNode reference -n "Ultimate_Walker_IK_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0.047098443938190106 -0.017623548205036921 0.36175280323895798"
		...
		"translate" " -type \"double3\" 0 -0.2211137399400287 -0.46913177666379136"
		2 "|Ultimate_Walker_IK_v1_0_1:AniM_walker_Main|Ultimate_Walker_IK_v1_0_1:Body_Rig_Grp|Ultimate_Walker_IK_v1_0_1:CNT_Grp|Ultimate_Walker_IK_v1_0_1:CTRL_Main_Grp|Ultimate_Walker_IK_v1_0_1:CTRL_Main" 
