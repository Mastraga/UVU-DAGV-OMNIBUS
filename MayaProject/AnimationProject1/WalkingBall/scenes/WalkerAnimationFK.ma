...
//Last modified: Sun, Oct 12, 2025 04:38:30 PM
//Codeset: 1252
...
fileInfo "UUID" "4F8FE733-4684-63B7-D171-5CBFBACD30AC";
createNode transform -s -n "persp";
	rename -uid "92216E9C-4F94-1E85-FA6B-9B855559947B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.0393496925383428 5.305943056410106 -5.2296537843994679 ;
	setAttr ".r" -type "double3" -5.1383527313286352 -217.00000000004644 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "17206660-430C-998B-8722-FBB793E017B0";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 4.1170287942593813;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B2EBE019-4B8F-AF19-7E92-799C703F4594";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "F5CF3C58-4ECB-5BDF-0607-7A9CBAE95E54";
createNode displayLayer -n "defaultLayer";
	rename -uid "223B350E-42F2-A889-034B-50BDAF79DC70";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "672C14E4-4FF4-10FA-6B82-A093BA963AFC";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "F6DF0D9A-4914-9BFB-717B-3A9A1A0B4BEB";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "11DDBC69-4053-6CC5-A9A8-6888755524FA";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C059FBB7-41BE-91BE-9DC8-3581798F7012";
createNode reference -n "Ultimate_Walker_FK_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"Ultimate_Walker_FK_v1_0_1RN" 40
