...
//Name: BonyIdle.ma
//Last modified: Mon, Nov 24, 2025 12:46:58 PM
//Codeset: 1252
...
fileInfo "UUID" "83D80771-4039-D6E6-6277-0B8360B3FF7A";
createNode transform -s -n "persp";
	rename -uid "285D4745-4B71-E68D-B675-4EAB20CE1678";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.9285852806972175 8.8972769382064705 7.0570692380797482 ;
	setAttr ".r" -type "double3" -18.938352729565793 -758.99999999979707 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A1385875-4FF9-93F8-2DB9-2B9D9B7C7799";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.391632915927921;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "ABD0235B-4BA3-EEF2-778F-5FB8870B73D4";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "180EEF85-4B68-3258-7303-AB91BCD87BB3";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "218FA2AD-4743-70C0-6BBE-A1A11871BD07";
createNode displayLayerManager -n "layerManager";
	rename -uid "761D223C-4B10-7566-0EB6-5898DCDF81DC";
createNode displayLayer -n "defaultLayer";
	rename -uid "0CE9CFB2-413C-1F34-5B0C-0C956C8CD510";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2D35BBBD-481A-18DA-947A-54B0DDBD02A5";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "C619F413-4213-4361-D2E4-3EBF784DC513";
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 13 ".ktv[0:12]"  0 1.5800015809660797 24 1.7901774328931581
		 36 1.6053987638481333 60 1.7901774328931581 73 9.7639080343779945 97 9.7639080343779945
		 107 1.5800015809660797 132 1.7901774328931581 144 1.6053987638481333 168 1.7901774328931581
		 180 1.6053987638481333 204 1.7901774328931581 216 1.6053987638481333;
	setAttr -s 13 ".kit[3:12]"  1 18 1 18 18 1 18 1 
		18 1;
	setAttr -s 13 ".kot[3:12]"  1 18 1 18 1 18 1 18 
		1 18;
...
connectAttr "Newskin.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
