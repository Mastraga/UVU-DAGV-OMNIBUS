...
//Name: BonyRun.ma
//Last modified: Fri, Oct 10, 2025 10:47:19 PM
//Codeset: 1252
...
fileInfo "UUID" "10CB2060-4542-26B4-80D8-4A8F8698352E";
createNode transform -s -n "persp";
	rename -uid "B580C43C-45C0-24FC-14E8-47BEAFE4909F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -14.895453466699314 6.427596669737861 10.338317724313923 ;
	setAttr ".r" -type "double3" -1.5383527295338493 1379.8000000000538 -3.9999010648391318e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CFE0F780-4D82-DAFF-2FF8-ECB6A373A990";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.857368303316857;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "CFE9AF86-4978-2D16-157D-E486C37B4FB8";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "3EA500A3-48C9-8B18-686C-ECB0CE4F0364";
createNode displayLayer -n "defaultLayer";
	rename -uid "5A7E2F42-4260-DC0F-60A3-CDAA0F67D750";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "33547537-498D-07B7-DA61-D48B7386E52F";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "1709CADD-43BE-6198-F28B-2D8AF83ECD1A";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CFD8992D-419A-09A5-8422-ADBC33681167";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8299FDFF-41E8-19F3-75AD-4B9FF8949692";
