...
//Name: BonyRun.ma
//Last modified: Fri, Oct 24, 2025 11:16:08 AM
//Codeset: 1252
...
fileInfo "UUID" "6F3A6D09-423F-A6D5-9479-E1A157AACAD4";
createNode transform -s -n "persp";
	rename -uid "B580C43C-45C0-24FC-14E8-47BEAFE4909F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.74873747883096375 9.6447925097235423 27.748748113603295 ;
	setAttr ".r" -type "double3" -11.138352729821865 1434.9999999997581 -9.9771996363925643e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CFE0F780-4D82-DAFF-2FF8-ECB6A373A990";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 33.446480942429737;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "21B3D93C-40B5-468D-1D94-25BD6F97F297";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A772592F-4AFF-3813-6E91-B89B84327B5C";
createNode displayLayer -n "defaultLayer";
	rename -uid "5A7E2F42-4260-DC0F-60A3-CDAA0F67D750";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6317C161-4CF0-0CDE-E794-E29B811A44AF";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "1709CADD-43BE-6198-F28B-2D8AF83ECD1A";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A82CB783-4261-9DF1-BEAC-A1B8B1F79705";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "94F1EAAB-47BD-E081-17C5-D88017604FCF";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "E5088031-40D3-BFBA-284C-5F91AABAF9F9";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -229.44676959408912 -194.04761133685977 ;
	setAttr ".tgi[0].vh" -type "double2" 308.01819504336976 44.047617297323981 ;
...
connectAttr "BodyColor.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
