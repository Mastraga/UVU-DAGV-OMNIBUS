...
//Name: BonyRun.ma
//Last modified: Thu, Oct 09, 2025 11:22:58 AM
//Codeset: 1252
...
fileInfo "UUID" "EEF7C570-4882-E789-322F-AEA90941073B";
createNode transform -s -n "persp";
	rename -uid "B580C43C-45C0-24FC-14E8-47BEAFE4909F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.070108605399717 6.6956124173781273 6.4567512673845631 ;
	setAttr ".r" -type "double3" -5.7383527295782226 1366.599999999657 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CFE0F780-4D82-DAFF-2FF8-ECB6A373A990";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 19.052408825052751;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FF960747-4CA2-E990-1CC8-4A9672624422";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "B55425C7-4B29-B7AE-5D92-029B267F84A0";
createNode displayLayer -n "defaultLayer";
	rename -uid "5A7E2F42-4260-DC0F-60A3-CDAA0F67D750";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D3B081AF-4213-A812-AAB5-5E92D33BC29F";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "1709CADD-43BE-6198-F28B-2D8AF83ECD1A";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0D8643CB-43FF-0318-C6C2-9CB12783DA14";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "ACC16FDC-4FBA-141A-98A3-CBA77D57E407";
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 35.30118986045522433 0.94583289052759101 -1.36387126427628225"
		...
		"rotate" " -type \"double3\" 0 0 -108.32689420972894823"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_rPalmCG|Ultimate_Bony_v1_0_5:Bony_rPalmC|Ultimate_Bony_v1_0_5:Bony_rFinger1J3CG|Ultimate_Bony_v1_0_5:Bony_rFinger1J3C" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTA -n "Bony_Spine02FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 9 ".ktv[0:8]"  1 9.9937310319043497 3 -17.33958060551937
		 5 -17.33958060551937 6 5.6573126175263662 9 -2.1180334264871066 11 -14.681787585300336
...
createNode animCurveTA -n "Bony_Spine03FKC_rotateX";
	...
	setAttr -s 9 ".ktv[0:8]"  1 5.2211281946462105 3 -16.304591440655734
		 5 7.4086167422246358 6 11.130086880056963 9 16.028890549967418 11 1.8656960070279498
...
createNode animCurveTA -n "Bony_SpineTopIKC_rotateX";
	...
	setAttr -s 9 ".ktv[0:8]"  1 -29.868492780477723 3 -11.503081922282284
		 ...
		 13 -35.561975215812645 14 -38.737809210976096 17 -52.702695392760852;
createNode animCurveTA -n "Bony_SpineTopIKC_rotateY";
	rename -uid "1CD90FC7-4812-E5D8-5C21-03BCA7760426";
	setAttr ".tan" 18;
	setAttr -s 9 ".ktv[0:8]"  1 -16.613926437571209 3 0.71408986704221011
		 5 21.12536595840654 6 13.959242573418098 9 9.3430570166321925 11 -7.6426674063686502
		 13 -23.591083470094969 14 -18.198131104131154 17 -9.2776635564642174;
createNode animCurveTA -n "Bony_SpineTopIKC_rotateZ";
	rename -uid "591CD621-4C7C-86AD-A22F-0E83CDA93702";
	setAttr ".tan" 18;
	setAttr -s 9 ".ktv[0:8]"  1 9.3249183891585865 3 -0.3878072098674008
		 5 -12.111836577191816 6 -7.7578403523632353 9 -2.8492849383371355 11 6.5979577081017231
		 13 24.204502912861663 14 15.220528756894325 17 2.5439831718218033;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 9 ".ktv[0:8]"  1 -3.3976079076417109 3 -3.3976079076417109
